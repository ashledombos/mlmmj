...
#         ynh_print_err --message="Both mail in and mail out are not activated for $list_domain"
#         return 1
#     elif [[ $incoming_mail_enabled != "1" ]]; then
#         ynh_print_err --message="Mail in is not activated for $list_domain"
#         return 1
#     elif [[ $outgoing_mail_enabled != "1" ]]; then
#         ynh_print_err --message="Mail out is not activated for $list_domain"
#         return 1
#     fi
